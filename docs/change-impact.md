...
| Formal-proof harness bootstrap | `internal/bridge/orchestration_harness.go`, `internal/bridge/orchestration.go:run`, formal-proof prompt composition, bridge tests, `docs/features/formal-proof-harness-bootstrap.md`, `docs/architecture.md`, `docs/code-map.md` |
