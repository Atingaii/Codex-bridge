...
| Orchestration verifier or terminal reason | deterministic verifier tests, Bridge relay-stop behavior, durable task-graph completion/recovery, `protocol.RunEndData`, Hub progress/public-share sanitizers, frontend timeline/plan/branch-map reducers, continuity and feature docs |
