...
| Orchestration usage statistics | `internal/bridge/orchestration_usage.go`, `internal/hub/orchestration.go:handleOrchestrationStats`, `frontend/src/app/pages/OrchestrationStatsPage.tsx`, `frontend/src/app/lib/types.ts`, `frontend/src/app/lib/i18n.ts`, embedded static UI, usage tests |
