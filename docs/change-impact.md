...
| Administrator usage analytics | `internal/store/admin_analytics.go`, `internal/hub/admin.go:handleAdminUsage`, `internal/hub/admin.go:handleAdminUserUsage`, admin authorization/privacy tests, `frontend/src/app/pages/AdminUsagePage.tsx`, `frontend/src/app/pages/AdminUserUsagePage.tsx`, administrator-only navigation, embedded static UI, `docs/features/admin-usage-dashboard.md` |
