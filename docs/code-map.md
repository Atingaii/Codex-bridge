...
| Orchestration plan/progress workspace | `internal/hub/task_graph.go:handleOrchestrationProgress`, `internal/hub/task_graph.go:reduceOrchestrationPlan`, `frontend/src/app/components/OrchestrationProgressMap.tsx:OrchestrationProgressMap`, `frontend/src/app/pages/OrchestrationWorkspace.tsx` |
| Orchestration cancel-before-delete state machine | `internal/store/store.go:RequestDeleteOrchestrationRun`, `internal/store/store.go:UpdateOrchestrationRunStatusIfAllowed`, `internal/hub/orchestration.go:handleDeleteOrchestration` |
