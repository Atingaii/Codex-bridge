...
assert.match(workspace, /mergeOrchestrationRunsPreservingOtherAgents\(current, incoming, agentId, activeRunIdRef\.current\)/);
assert.match(workspace, /run\.agentId !== agentId \|\| run\.id === activeRunId/);
