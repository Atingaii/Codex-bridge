...
import { BookOpen, Check, Edit2, GitBranch, History, MessageSquare, Plus, RefreshCw, Search, Settings, Share2, Terminal, Trash2 } from 'lucide-react';
  ...
  return (
    <>
      ...
      <div className="p-3 border-t border-sidebar-border shrink-0 mt-auto bg-sidebar">
        ...
        <a href="/updates" className="mb-1 flex w-full items-center gap-2 rounded-md px-2 py-1.5 text-sm text-muted-foreground transition-colors hover:bg-sidebar-accent hover:text-sidebar-foreground">
