...
export const uiText = {
  en: {
    ...
    userConversationDetailsSubtitle: 'Read-only titles, status, endpoints, activity, and usage',
    ...
    readOnlyMetadataNotice: 'Read-only metadata. Prompts, messages, paths, and native session IDs are not exposed.',
  ...
  zh: {
    ...
    userConversationDetailsSubtitle: '只读查看标题、状态、端点、活动与用量',
    ...
    readOnlyMetadataNotice: '仅展示只读元数据，不开放提示词、消息正文、路径或原生 Session ID。',
    perCli: '按 CLI 和模型',
